package network.stratus.ubique.inject;
...
public interface ForwardingBinder extends Binder {
    ...
    @Override
    default void bindInterceptor(Matcher<? super Class<?>> classMatcher,
    ...
    @Override
    default void convertToTypes(Matcher<? super TypeLiteral<?>> typeMatcher,
    ...
    @Override
    default void bindListener(Matcher<? super Binding<?>> bindingMatcher,
